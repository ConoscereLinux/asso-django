...
class EventSession(TitleModel, SoftDeletableModel, TimeStampModel):
    ...
    event = models.ForeignKey(
        ...
        null=False,
        blank=False,
        help_text=_("The event this session is assigned to"),
    )
...
class Event(ContentModel):
    ...
    start_date = models.DateField(
        ...
        blank=True,
        editable=False,
        verbose_name=_("The starting date this event (autogenerated)"),
    )
    ...
    end_date = models.DateField(
        ...
        blank=True,
        editable=False,
        verbose_name=_("The ending date of this event (autogenerated)"),
    )
